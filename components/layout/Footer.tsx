...
// ponytail: inline SVG — lucide-react has no brand icons, no new dep needed
      ...
      <div className="mx-auto max-w-6xl px-6 py-8 lg:px-8">
        <div className="hidden sm:grid sm:grid-cols-3 sm:items-center">
          <div className="flex items-center gap-2.5">
            ...
            />
            <span className="text-sm font-medium text-text-secondary">Maxime Luet</span>
          </div>
          <p className="text-xs text-text-tertiary text-center">
            © {new Date().getFullYear()} Maxime Luet
          </p>
