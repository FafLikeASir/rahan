...
<CaseFigure
  src="/case-studies/ekonsilio/reporting-leads.jpg"
  alt="eKonsilio product screens — cards, buttons, badges, dropdowns, and charts built from the design system's token set"
  caption="The system in production — cards, buttons, badges, dropdowns, and charts, all composed from the same color, type, and spacing tokens."
/>
...
<CaseFigure
  src="/case-studies/ekonsilio/lead-card.jpg"
  alt="eKonsilio lead detail screen — client identity, trade-in vehicle, and dealership"
  caption="A lead's detail view — client identity, trade-in vehicle, and the dealership it routes to. Lead capture, replacing HubSpot."
/>
...
<PipelineDiagram
  steps={[
    { tool: 'Figma', role: 'design' },
    { tool: 'Zeplin', role: 'handoff' },
    { tool: 'Storybook', role: 'component documentation' },
    { tool: 'React', role: 'production code' },
  ]}
  caption="The design-to-dev pipeline. Four tools, one direction of flow: design — handoff — component documentation — production code."
/>
...
<CaseFigure
  src="/covers/ekonsilio.jpg"
  alt="eKonsilio's full reporting dashboard — global stats, conversations, and leads across every channel"
  caption="eKonsilio by 2022 — the product the design system had scaled to support, across a five-person engineering team."
/>
